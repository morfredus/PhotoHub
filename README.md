...
![PhotoHub main window (example data)](docs/pictures/interface.png)

*Illustration only: the selected morfPhoto source, the library statistics, and the
watched folders with their state (removable media, analytics exclusion). Values,
paths and hosts are **anonymized example data**.*
